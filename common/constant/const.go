...
const (
	...
	FUZZY_WATCH_REQUEST_NAME               = "NamingFuzzyWatchRequest"
	FUZZY_WATCH_SYNC_REQUEST_NAME          = "NamingFuzzyWatchSyncRequest"
	FUZZY_WATCH_CHANGE_NOTIFY_REQUEST_NAME = "NamingFuzzyWatchChangeNotifyRequest"
)
